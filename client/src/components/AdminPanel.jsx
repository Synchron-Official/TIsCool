                    ...
                    <div className="grid gap-6 md:grid-cols-4">
                        <div className="bg-white dark:bg-zinc-900 p-6 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-sm relative overflow-hidden group">
                            ...
                            <div>
                                ...
                                <div className={`text-xs mt-2 flex items-center gap-1 ${stats?.systemStatus === 'Maintenance' ? 'text-red-500' : 'text-green-600'
                                    }`}>
                                    <Zap size={16} className="font-bold" />
                                    {stats?.systemStatus === 'Maintenance' ? 'Maintenance' : 'Operational'}
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        {['info', 'warning', 'error'].map((type) => (
                            <button
                                ...
                                className={`py-3 rounded-xl border capitalize font-medium transition-all ${broadcastType === type
